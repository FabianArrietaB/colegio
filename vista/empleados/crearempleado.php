                            ...
                            <div class="col-3">
                                <div class="input-group mb-3">
                                    <select name="codeps" id="codeps" class="form-control input-sm">
                                        ...
                                        <?php
                                            $sql="SELECT p.id_parafiscal as idparafiscal, p.par_nombre as nombre FROM parafiscales as p where p.id_tipo = 1";
                            ...
                            <div class="col-3">
                                <div class="input-group mb-3">
                                    <select name="codarl" id="codarl" class="form-control input-sm">
                                        ...
                                        <?php
                                            $sql="SELECT p.id_parafiscal as idparafiscal, p.par_nombre as nombre FROM parafiscales as p where p.id_tipo = 2";
                                            $respuesta = mysqli_query($conexion, $sql);
                                            while($parafiscales = mysqli_fetch_array($respuesta)) {
                                            ?>
                                            <option value="<?php echo $parafiscales['idparafiscal']?>"><?php echo $parafiscales['nombre'];?></option>
