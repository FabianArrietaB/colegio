    ...
    <table class="table table-light text-center"">
        ...
        <?php while ($solicitudes = mysqli_fetch_array($query)) { ?>
            <tr>
                ...
                <td>
                    <?php if ($solicitudes['tiposolicitud'] == 1){ ?><button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#ventas"><i class="fa-solid fa-stamp fa-xl"></i></button> <?php } ?>
                </td>
            </tr>
        <?php } ?>
        </tbody>
